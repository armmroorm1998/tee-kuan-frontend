    ...
    return (
      <div className="max-w-lg mx-auto min-h-dvh flex flex-col">
        ...
        <div className="flex-1 px-4 space-y-3">
          ...
          <a
            href="https://forms.gle/rZRSd7ztBGjyJqBUA"
            target="_blank"
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-bold text-gray-800 text-base">แจ้งปัญหา / ข้อเสนอแนะ</div>
                <div className="text-xs text-gray-400 mt-0.5">พบบั๊กหรืออยากให้เพิ่มฟีเจอร์ บอกเราได้เลย</div>
              </div>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-300 shrink-0" />
          </a>
